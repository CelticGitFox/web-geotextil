...
import {LoginAdmService} from './loginAdm.service';
...
@Component({
  ...
  styleUrls: ['./loginAdm.component.sass']
})
export class LoginAdmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private _logService: LoginAdmService,
