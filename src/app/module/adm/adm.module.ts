...
@NgModule({
  ...
  ListJobsComponent, ListPromotionsComponent, DetailCommerceComponent, RegisterCommerceComponent, DetailuserComponent, DetailJobsComponent, DetailPromotionsComponent,ListBlogComponent, RegisterBlogComponent],
  imports: [
    AdmRoutes,
    CommonModule,
    FormsModule,
